...
{#if selectedLetter}
	<div class="border-2  p-3 border-gray-100 flex flex-col rounded-lg">
...
{#if user?.admin}
	<div class="border-2 p-3 border-gray-100 rounded-lg">
		...
		<form class="mt-2" method="POST" enctype="multipart/form-data">
			...
			<div class="flex flex-row mb-2">
				...
				class="ml-2 px-2 border-gray-100 border-2 rounded w-full"
				name="letter"
				placeholder="Letter*">
			</div>
			<div class="flex flex-row mb-2">
	...
	<div class="border-2 p-3 border-gray-100 rounded-lg">
		...
		<form class="mt-2" method="POST">
			<div class="flex flex-row items-center mb-2">
				...
				<input class="ml-2 px-2 border-gray-100 border-2 rounded w-full" name="id" placeholder="id">
			</div>
			<div class="flex flex-row items-center mb-2">
				<label class="font-bold" for="username">Username: </label>
				<input class="ml-2 px-2 border-gray-100 border-2 rounded w-full" name="username" placeholder="username">
			</div>
			<button class="mt-2 bg-zoranje active:bg-orange-600 text-white w-full px-2 py-1 rounded" type="submit"
